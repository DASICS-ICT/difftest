...
class DiffCSRStateIO extends DifftestBundle {
  ...
  val dasicsMainCfg = Input(UInt(64.W))
  val dasicsSMBoundLo = Input(UInt(64.W))
  val dasicsSMBoundHi = Input(UInt(64.W))
  val dasicsUMBoundLo = Input(UInt(64.W))
  val dasicsUMBoundHi = Input(UInt(64.W))
  val dasicsLibCfg = Input(UInt(64.W))
  val dasicsLibBound = Input(Vec(32, UInt(64.W)))
  val dasicsMainCall = Input(UInt(64.W))
  val dasicsReturnPC = Input(UInt(64.W))
  val dasicsAZoneReturnPC = Input(UInt(64.W))
  val dasicsFReason = Input(UInt(64.W))
  val dasicsJumpCfg = Input(UInt(64.W))
  val dasicsJumpBound = Input(Vec(8, UInt(64.W)))
  val upkru = Input(UInt(64.W))
  val spkrs = Input(UInt(64.W))
  val spkctl = Input(UInt(64.W))
  val menvcfg = Input(UInt(64.W))
  val senvcfg = Input(UInt(64.W))
  val mseccfg = Input(UInt(64.W))
}
