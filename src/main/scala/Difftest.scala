...
class DiffCSRStateIO extends DifftestBundle {
  ...
  val uscratch = Input(UInt(64.W))
  val mideleg = Input(UInt(64.W))
  val sideleg = Input(UInt(64.W))
  val medeleg = Input(UInt(64.W))
  val sedeleg = Input(UInt(64.W))
  val dsmcfg = Input(UInt(64.W))
  val dsmbound0 = Input(UInt(64.W))
  val dsmbound1 = Input(UInt(64.W))
  ...
  // val dlbound3 = Input(UInt(64.W))
  // val dlbound4 = Input(UInt(64.W))
  // val dlbound5 = Input(UInt(64.W))
  // val dlbound6 = Input(UInt(64.W))
  // val dlbound7 = Input(UInt(64.W))
  // val dlbound8 = Input(UInt(64.W))
  // val dlbound9 = Input(UInt(64.W))
  // val dlbound10 = Input(UInt(64.W))
  // val dlbound11 = Input(UInt(64.W))
  // val dlbound12 = Input(UInt(64.W))
  // val dlbound13 = Input(UInt(64.W))
  // val dlbound14 = Input(UInt(64.W))
  // val dlbound15 = Input(UInt(64.W))
  // val dlbound16 = Input(UInt(64.W))
  // val dlbound17 = Input(UInt(64.W))
  // val dlbound18 = Input(UInt(64.W))
  // val dlbound19 = Input(UInt(64.W))
  // val dlbound20 = Input(UInt(64.W))
  // val dlbound21 = Input(UInt(64.W))
  // val dlbound22 = Input(UInt(64.W))
  // val dlbound23 = Input(UInt(64.W))
  // val dlbound24 = Input(UInt(64.W))
  // val dlbound25 = Input(UInt(64.W))
  // val dlbound26 = Input(UInt(64.W))
  // val dlbound27 = Input(UInt(64.W))
  // val dlbound28 = Input(UInt(64.W))
  // val dlbound29 = Input(UInt(64.W))
  // val dlbound30 = Input(UInt(64.W))
  // val dlbound31 = Input(UInt(64.W))
  
  val dmaincall = Input(UInt(64.W))
  val dretpc = Input(UInt(64.W))
  val dretpcfz = Input(UInt(64.W))

  // val djbound0lo = Input(UInt(64.W))
  // val djbound0hi = Input(UInt(64.W))
  // val djbound1lo = Input(UInt(64.W))
  // val djbound1hi = Input(UInt(64.W))
  // val djbound2lo = Input(UInt(64.W))
  // val djbound2hi = Input(UInt(64.W))
  // val djbound3lo = Input(UInt(64.W))
  // val djbound3hi = Input(UInt(64.W))
  // val djcfg = Input(UInt(64.W))
}
