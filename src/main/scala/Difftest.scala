...
class DiffCSRStateIO extends DifftestBundle {
  ...
  val dretpc0 = Input(UInt(64.W))
  val dretpc1 = Input(UInt(64.W))
  val dretpc2 = Input(UInt(64.W))
  val dretpc3 = Input(UInt(64.W))
  val dllevel = Input(UInt(64.W))
  val djlevel = Input(UInt(64.W))
